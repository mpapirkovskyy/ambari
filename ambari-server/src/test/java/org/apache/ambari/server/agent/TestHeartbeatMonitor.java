...
public class TestHeartbeatMonitor {
  ...
  public void testHeartbeatLoss() throws AmbariException, InterruptedException,
    ...
    HeartBeatHandler handler = new HeartBeatHandler(configuration, fsm, aq, am, injector);
  ...
  public void testStateCommandsGeneration() throws AmbariException, InterruptedException,
    ...
    HeartBeatHandler handler = new HeartBeatHandler(configuration, clusters, aq, am, injector);
    Register reg = new Register();
  ...
  public void testHeartbeatStateCommandsEnqueueing() throws AmbariException, InterruptedException,
    ...
    Configuration configuration = mock(Configuration.class);
    when(configuration.getHeartbeatMonitorInterval()).thenReturn(60000);
    HeartBeatHandler handler = new HeartBeatHandler(configuration, clusters, aqMock,
                                                      am, injector);
    Register reg = new Register();
    reg.setHostname(hostname1);
    reg.setResponseId(12);
