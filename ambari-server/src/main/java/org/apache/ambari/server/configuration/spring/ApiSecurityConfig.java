  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.csrf().disable()
        ...
        .headers().httpStrictTransportSecurity()
            .includeSubDomains(guiceBeansConfig.ambariConfig().getStrictTransportSecurityHTTPResponseHeaderIncludeSubdomains())
            .maxAgeInSeconds(guiceBeansConfig.ambariConfig().getStrictTransportSecurityHTTPResponseHeaderMaxAge()).and()
